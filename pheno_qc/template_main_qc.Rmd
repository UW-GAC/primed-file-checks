...
print(paste0("Table name params in template_main_qc: ", grandchild_document_table_names))
```
...
for (i in 1:length(grandchild_document_table_names)) {
  ...
  print(paste0("template_main_qc starting qc check for table: ", grandchild_document_table_name))
  print(paste0("template_main_qc starting qc check for file: ", grandchild_document_file_name))
  print(paste0("i = ", i))
