...
# df <- read.table(file = '/home/rstudio/primed-file-checks/pheno_qc/test_data/cmqt_blood_pressure.tsv', sep = '\t', header = TRUE)
print(file_name)
```
...
vars_df <- vars_df %>% add_row(
  ...
  qc_fail_max = NULL, 
  qc_null = c(sum(sapply(this_table$systolic_bp_1 | this_table$diastolic_bp_1,is.na)))
)
