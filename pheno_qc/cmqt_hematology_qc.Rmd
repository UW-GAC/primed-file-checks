...
test_df <- read.table(file = '/home/rstudio/primed-file-checks/pheno_qc/test_data/cmqt_hematology.tsv', sep = '\t', header = TRUE)
```

### CMQT Hematology QC limits
```{r}
...
kable(df, col.names = c('Variable', 'Min Value', 'Max Value'),  caption = "Min and max extreme values for hematology variables")
```

### CMQT Hematology QC checks
```{r}
