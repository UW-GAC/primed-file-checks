...
# grandchild_document_file_name <- 'gs://fc-secure-0285a1eb-c88a-4ea6-b970-ec5e092784ea/uploaded_data_prevent/aric_cmqt_glycemic.tsv'
...
```{r}
grandchild_documents <- c(
  "cmqt_anthropometry_qc.Rmd",
  "cmqt_lipids_qc.Rmd",
  "cmqt_hematology_qc.Rmd",
  "cmqt_blood_pressure_qc.Rmd"
)

if(this_grandchild_document %in% c(grandchild_documents)) {
