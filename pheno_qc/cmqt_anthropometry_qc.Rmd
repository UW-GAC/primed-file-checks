...
- bmi_consistency: Difference between reported BMI and calculated BMI
  - Min Value: NA
  - Min Value: NA
  - Pass QC: number of samples with reported BMI within a tolerance level of `r bmi_tolerance` of calculated BMI
  - Fail QC Min: number of samples with reported BMI difference less than (calculated BMI - `r bmi_tolerance`)
  - Fail QC Max: number of samples with reported BMI difference greater than (calculated BMI + `r bmi_tolerance`)
